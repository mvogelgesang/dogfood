...
export default function LatestArticles({ posts }: LatestArticlesProps) {
  return (
    <section className="mb-16">
      <h2 className="text-3xl font-bold mb-8 text-light-heading dark:text-dark-heading">
        Latest Stories
      </h2>
        ...
        {posts.map((post) => (
          ...
          >
            ...
            <div className="p-6">
              ...
              <h3 className="text-xl font-semibold mb-3 text-light-heading dark:text-dark-heading">
                <Link
